...
function Sidebar() {
  return (
    <div className="w-80 min-w-20 md:min-w-80 min-h-screen border border-black border-t-0 border-l-0 border-b-0">
      <div className="py-10 pl-4 flex flex-col gap-8">
        <NavLink
          to={"/add"}
          className={({ isActive }) =>
            `justify-start md:flex md:items-center gap-4 border border-black border-r-0 rounded-md p-6 cursor-pointer ${
